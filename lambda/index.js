...
const AccountLinkingInterceptor = require('./interceptors/AccountLinkingInterceptor');
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, soy lucia, tu asistente virtual. ¿En qué puedo ayudarte hoy?';
